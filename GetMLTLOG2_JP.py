...
cmdlineopt.add_argument('-Pickle', action="store_true", dest="DoPickle",  default=False, help='do the python pickle for workbook and worksheet,  default= Faluse' )
...
DoPickle = cmdlineresults.DoPickle
...
period = "20120601-20121111"
diroutput = "D:\\temp_MLT_L05D"
modelname = "L05D"
#LogFileCopy = True
# ShutdownAfter = True
#DoPickle = True 
...
for dictmltlogs in listdictmltlogs:
    ...
    AnalyzerMLTLOG.writeResultToExcel( dictAdditionalBaicInfo )
...
if DoPickle == True :    
    AnalyzerMLTLOG.doPickle(excelsavingname)
