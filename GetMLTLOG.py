...
cmdlineopt.add_argument('-only', action="store_true", dest="OnlyStatistics",  default=False, help='gather only the SVC, MLT LOG summary, not including the analyzing,  default= Faluse' )
...
OnlyStatistics = cmdlineresults.OnlyStatistics
...
ServiceStatement = "select * from  dmr_service_history  where ( %s )  and  cause_cd = 'MDA' and  receipt_ymd between '%s' and '%s'   "
