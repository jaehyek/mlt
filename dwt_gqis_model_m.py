...
'''
usage : dwt_gqis_model_m.py  -o c:\temp_mlt 
'''

cmdlineopt = argparse.ArgumentParser(description='get the dwt_gqis_model_m  from MLT Server 10.185.135.57')
...
statement = "select * from dwt_gqis_model_m "
...
fieldnames = ['creation_dt','launching_ymd','product_level4_name','product_level2_name','model_code','product_level3_code','product_level3_name','basic_model_code','product_level2_code','affiliate_code','product_level4_code' ]
