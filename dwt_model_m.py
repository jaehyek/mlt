...
'''
usage : dwt_model_m.py  -o c:\temp_mlt 
'''

cmdlineopt = argparse.ArgumentParser(description='get the dwt_model_m  from MLT Server 10.185.135.57')
...
statement = "select * from dwt_model_m "
...
fieldnames = ['avg_ram_size','gathering_yn','creation_dt','reg_ymd','country_cd','model_name' ]
