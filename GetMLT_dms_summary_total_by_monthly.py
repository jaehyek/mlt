...
# variables.
diroutput = "."
outputtitle = "GetMLT_dms_summary_total_by_monthly"
...
'''
usage : GetMLT_dms_summary_total_by_monthly.py  -o c:\temp_mlt
'''

cmdlineopt = argparse.ArgumentParser(description='get the GetMLT_dms_summary_total_by_monthly  from MLT Server 10.185.135.57')
...
statement = "select * from dms_summary_total_by_monthly"
...
''' field name '''
fieldnames = ['sw_version','total_shipping_count','creation_dt','creation_id','base_yymm','last_update_dt','country_cd','total_receive_count','last_update_id','model_name' ]
