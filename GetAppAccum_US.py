...
diroutput = "D:\\temp_MLT_US"
SavingHeadName = "US"
period = '20130201-20130418'
modelname = "LGVS920"
'''
...
LOGstatement = '''select *  from    dmd_log_m where 
...
base_ymd between '20130201' and '20130418'
...
# dictlistAppAccumInfo = { "com.lge.camera": [total_time_ms, totla_count], "com.android.settings": [total_time_ms, totla_count] }
...
for packagename in listkeys :
    ...
    ws.cell(coords=(rindex, cindex,  ),  value = packagename )
    cindex += 1
