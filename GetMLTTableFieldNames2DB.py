...
# variables.
diroutput = "."
outputtitle = "GetMLTTableFieldNames2DB"
...
statement = "SELECT Distinct TABLE_NAME FROM LS_MLTDBO.LGMLTPO.information_schema.TABLES"
...
for tablename in tablenamelist :
    statement_fieldlist = "select * from LS_MLTDBO.LGMLTPO.dbo." + tablename
    try:
