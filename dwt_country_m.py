...
'''
usage : dwt_country_m.py  -o c:\temp_mlt 
'''

cmdlineopt = argparse.ArgumentParser(description='get the dwt_country_m  from MLT Server 10.185.135.57')
...
statement = "select * from dwt_country_m "
