...
# variables.
diroutput = "."
outputtitle = "GetMLTSymptonCodeMapGQIS"
...
'''
usage : GetMLTSymptonCodeMapGQIS.py  -o c:\temp_mlt 
'''

cmdlineopt = argparse.ArgumentParser(description='get the GetMLTSymptonCodeMapGQIS  from MLT Server 10.185.135.57')
