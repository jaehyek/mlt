...
# variables.
diroutput = "."
outputtitle = "GetMLT_dmr_product_by_model"
...
'''
usage : GetMLT_dmr_product_by_model.py  -o c:\temp_mlt
'''

cmdlineopt = argparse.ArgumentParser(description='get the GetMLT_dmr_product_by_model  from MLT Server 10.185.135.57')
...
statement = "select * from LS_MLTDBO.LGMLTPO.dbo.om_target_model_info"
...
''' field name '''
#fieldnames = ['sw_version','creation_dt','creation_id','last_update_dt','shipping_count','product_month','country_cd','last_update_id','model_name',]
fieldnames = ['creation_dt','reg_ymd','buyer_model_name','model_name' ]
