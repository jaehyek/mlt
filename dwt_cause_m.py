...
'''
usage : dwt_cause_m.py  -o c:\temp_mlt 
'''

cmdlineopt = argparse.ArgumentParser(description='get the dwt_cause_m  from MLT Server 10.185.135.57')
...
fieldnames = ['cause_group_name','source_system','creation_dt','cause_cd','cause_desc' ] 
