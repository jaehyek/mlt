...
if __name__ == '__main__':
    ...
    cmdlineopt.add_argument('-head', action="store_true", dest="bhead", default="",  help=' print just 2 line of head of file ' )
    ...
    bhead = cmdlineresults.bhead
    
    filename = r"Total_Call.xlsx"
    boolcsvout = True 
    textinfile = "('영상통화' or 'VT call' or 'Video call' ) and ( 3G or 4G)"
    
    
    
    # filename = r"D:\temp10\CIC0128.csv"
    # textsearch = "(»çÁø or °¶·¯¸®) and (»ç¶ó or Áö¿ö)"
    # textindex = "5"
    # boolcsvout = True
    ...
    # textsearch ¿Í textinfile Àº µÑ Áß ÇÏ³ª¸¸ searchÇÑ´Ù.        
    ...
    if bhead == True :
        print unicode(Hread.next(), "cp949").encode("utf8")
        print Hread.next()
        exit()
