...
# variables.
diroutput = "."
outputtitle = "GetMLTCauseCodeMap"
...
'''
usage : GetMLTCauseCodeMap.py  -o c:\temp_mlt 
'''

cmdlineopt = argparse.ArgumentParser(description='get the GetMLTCauseCodeMap  from MLT Server 10.185.135.57')
...
statement = "select * from dwt_cause_m "
...
''' field name '''
fieldnames = [ 'cause_cd','cause_desc','cause_group_name','source_system','creation_dt' ]
