...
# variables.
diroutput = "."
outputtitle = "dwt_outgo_sw_version_m"
...
'''
usage : dwt_outgo_sw_version_m.py  -o c:\temp_mlt 
'''

cmdlineopt = argparse.ArgumentParser(description='get the dwt_outgo_sw_version_m  from MLT Server 10.185.135.57')
...
statement = "select * from dwt_outgo_sw_version_m "
